...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    @Override
    @Transactional
    public void proccess(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        approvalOutboxHelper.save(getUpdatedOutboxMessage(orderApprovalOutboxMessage,order.getOrderStatus(),sagaStatus));
    ...
    public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        approvalOutboxHelper.save(getUpdatedOutboxMessage(orderApprovalOutboxMessage,
    ...
    private OrderApprovalOutboxMessage getUpdatedOutboxMessage(OrderApprovalOutboxMessage orderApprovalOutboxMessage,
