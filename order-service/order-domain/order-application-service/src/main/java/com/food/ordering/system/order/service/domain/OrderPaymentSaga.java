...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    @Override
    @Transactional
    public void proccess(PaymentResponse paymentResponse) {
        ...
        approvalOutboxHelper.saveApprovalOutboxMessage(orderDataMapper.
                    orderPaidEventToOrderApprovalEventPayload(orderPaidEvent),
    ...
    public void rollback(PaymentResponse paymentResponse) {
        ...
        if (orderPaymentOutboxMessageResponse.isEmpty()){
            log.info("An outbox message with saga id : {} is already roll back " , paymentResponse.getSagaId());
            return;
        }
