...
public class ApprovalOutboxHelper {
    ...
    public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage){
        ...
        if (response == null){
            ...
            throw new OrderDomainException("Could not save OrderPaymentOutboxMessage with outbox id : " + orderApprovalOutboxMessage.getId());
        }
        log.info("OrderApprovalOutboxMessage saved with id : {} " , response.getId());
    }
    ...
    @Transactional
    public void deleteOrderApprovalOutboxByOutboxStatusAndSagaStatus(OutboxStatus outboxStatus,SagaStatus... sagaStatus){
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        ...
        try {
            ...
            log.error("Could not create OrderApprovalEventPayload object for order id : {} " , orderApprovalEventPayload.getOrderId(),e);

            throw new OrderDomainException("Could not create OrderApprovalEventPayload object for order id : {} " + orderApprovalEventPayload.getOrderId(),e);
