...
public class PaymentOutboxCleanerScheduler implements OutboxScheduler {
    ...
    public void processOutboxMessage() {
        ...
        Optional<List<OrderPaymentOutboxMessage>> outboxMessageResponse = paymentOutboxHelper.getPaymentOutboxMessageByOutboxStatusAndSagaStaus(
        ...
        if (outboxMessageResponse.isPresent()) {
            ...
            paymentOutboxHelper.deletePaymentOutboxByOutboxStatusAndSagaStatus(OutboxStatus.COMPLETED,
                    SagaStatus.SUCCEEDED,
                    SagaStatus.FAILED,
                    SagaStatus.COMPENSATED);
