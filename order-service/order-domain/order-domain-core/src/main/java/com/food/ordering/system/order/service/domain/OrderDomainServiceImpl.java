...
//        Map<ProductId, Product> productsById = restaurant.getProducts()
//                .stream()
//                .collect(Collectors.toMap(Product::getId, Function.identity()));
//
//        for (OrderItem item : order.getItems()) {
//            Product confirmed = productsById.get(item.getProduct().getId());
//
//            if (confirmed != null) {
//                item.getProduct().updateWithConfirmedNameAndPrice(
//                        confirmed.getName(),
//                        confirmed.getPrice()
//                );
//            }
