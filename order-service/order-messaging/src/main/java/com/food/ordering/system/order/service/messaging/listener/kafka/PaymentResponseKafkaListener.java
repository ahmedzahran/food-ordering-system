...
public class PaymentResponseKafkaListener implements KafkaConsumer<PaymentResponseAvroModel> {
    ...
    public void receive(@Payload List<PaymentResponseAvroModel> messages,
        ...
        log.info("{} number of payment responses received with keys : {} , and partitions : {} and offset : {}",
                messages.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString());
        ...
        messages.forEach(paymentResponseAvroModel -> {
            if (PaymentStatus.COMPLETED == paymentResponseAvroModel.getPaymentStatus()){
                log.info("Processing successfully for order id: {} ", paymentResponseAvroModel.getOrderId());
                ...
                log.info("Processing Unsuccessfully for order id: {} ", paymentResponseAvroModel.getOrderId());
