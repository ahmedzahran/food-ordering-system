...
@Slf4j
@Component
public class OrderPaymentPublisher implements PaymentRequestMessagePublisher {
    ...
    public OrderPaymentPublisher(OrderMessagingDataMapper orderMessagingDataMapper,
    ...
    public void publish(OrderPaymentOutboxMessage orderPaymentOutboxMessage,
        ...
        log.info("Received OrderPaymentOutboxMessage for order with id : {} and saga id : {} " ,
        ...
        try{
            ...
            kafkaProducer.send(
                    ...
                    kafkaMessageHelper.getKafkaCallbackNew(
                            orderServiceConfigData.getPaymentRequestTopicName(),
                            paymentRequestAvroModel,
